...
package 
{
	...
	//  Main script3 class
	public class script3 extends MovieClip
	{
		...
		// Descript3ion, Caption Data
		private var cTime:Number = 1; 	//Caption fade in, fade out
		private var dTime:Number = 1; 	//Descript3ion fade in, fade out
		...
		private var ml:myloader = new myloader();
		...
		//______________________________________________________________________Main script3
		//Constructor
		
		public function script3():void
		{
		...
		private function update3D(e:Event):void
		{
			...
			{	
				...
				if (camera.y + del2 >= -900 && camera.y + del2 <= 900)	camera.y += del2;
			}
		...
		private function rePosition(e:Event):void
		{
			...
			des.x = container.x + 40;
			des.y = (stage.stageHeight - des.height) * 0.5 + 10 ;
		}
		...
		{
			gal.buttonMode = gal2.buttonMode = gal4.buttonMode = true;
